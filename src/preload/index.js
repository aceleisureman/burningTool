...
contextBridge.exposeInMainWorld('api', {
  ...
  toolchainSystemPathStatus: () => ipcRenderer.invoke('toolchain-system-path-status'),
  toolchainSystemPathAdd: () => ipcRenderer.invoke('toolchain-system-path-add'),
  toolchainSystemPathRemove: () => ipcRenderer.invoke('toolchain-system-path-remove'),
